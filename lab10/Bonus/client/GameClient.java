        ...
        try {
            ...
            while (!server_stopped) {
                ...
                if (request.equals("exit")) {
                    ...
                    break;
                } else if ((request.equals("create game") || request.matches("join game \\d{4}"))) {
                    if (!client.alreadyInGame) {
                    ...
                    System.out.println("Invalid command.\nPlease try again from commands: 'create game', 'join game <4 digit code>', 'active games' & 'submit move'.");
                    continue;
                }
